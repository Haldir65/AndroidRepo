package com.me.harris.androidanimations._33_notificationservice;
...
/**
 * Created by Fermi on 2017/4/26.
 */

public class NotificationMainActivity extends Activity {

    private static final String TAG = "SevenNLS";
    private static final String TAG_PRE = "["+NotificationMainActivity.class.getSimpleName()+"] ";
    ...
    private void createNotification(Context context) {
        ...
        ncBuilder.setSmallIcon(R.drawable.ic_delete);
