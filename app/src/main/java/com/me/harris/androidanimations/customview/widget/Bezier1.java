...
public class Bezier1 extends View {
    ...
    public Bezier1(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float textWidth = mTextPaint.measureText("Bezier1");
        canvas.drawText("Bezier1", centerX-textWidth/2, centerY * 1.5f, mTextPaint);
    }
}
