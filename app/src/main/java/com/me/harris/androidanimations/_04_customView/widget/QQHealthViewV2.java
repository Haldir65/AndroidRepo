 ...
 */
public class QQHealthViewV2 extends View {
    ...
    public QQHealthViewV2(Context context) {
        super(context, null);
    }

    public QQHealthViewV2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QQHealthViewV2(Context context, AttributeSet attrs, int defStyleAttr) {
